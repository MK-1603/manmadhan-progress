...
export function StartFocusModal({ isOpen, onClose, tasks, projects, onStartSession }: StartFocusModalProps) {
  ...
  return (
    <GlobalSheet
      ...
      icon={<Target className="w-4.5 h-4.5 text-[#C9A52A] dark:text-[#D4B12F]" />}
    ...
    >
      <div className="space-y-3.5 text-xs select-text">
        {/* Global Error Banner */}
        {error && (
          <div className="p-3 bg-rose-500/10 border border-rose-500/20 rounded-lg text-rose-600 dark:text-rose-400 text-[12px] flex items-center gap-2">
        ...
        <div className="grid grid-cols-3 border border-[#E4E7EC] dark:border-[#272D36] bg-[#F8F9FB] dark:bg-[#111419] p-1.5 gap-1 rounded-xl">
          <button
            type="button"
