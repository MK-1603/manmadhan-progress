...
import { Loader2, Check, ArrowRight, ArrowLeft, Shield, Building, Clock, CheckCircle2, User, Search, ChevronDown, Eye, EyeOff, Edit2, X, Sun, Moon } from "lucide-react";
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center p-4 ${isLight ? "bg-[#F4F4F5] text-[#18181B]" : "bg-[#050505] text-[#F5F5F5]"}`}>
        <div className="flex flex-col items-center gap-3">
          ...
          <span className={`text-xs font-medium ${isLight ? "text-[#71717A]" : "text-[#A1A1AA]"}`}>Validating setup link...</span>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className={`min-h-screen flex items-center justify-center p-4 ${isLight ? "bg-[#F4F4F5] text-[#18181B]" : "bg-[#050505] text-[#F5F5F5]"}`}>
        <div className={`border p-8 rounded-2xl max-w-[420px] w-full text-center space-y-4 shadow-2xl ${isLight ? "bg-[#FFFFFF] border-[#E4E4E7]" : "bg-[#101010] border-[#222222]"}`}>
          ...
          <h2 className="text-base font-bold">Link Invalid or Expired</h2>
                ...
                {step === 0 && (
                  <div className="pt-2 lg:pt-0">
                    <motion.div 
                      ...
                      className="space-y-1"
                    >
                      <h1 className={`text-xl sm:text-2xl font-bold tracking-tight text-left ${isLight ? "text-[#18181B]" : "text-[#F5F5F5]"}`}>Account Activation</h1>
                      <motion.p 
                    ...
                    <div className="space-y-3 mt-5">
                      ...
                      >
                        ...
                        <motion.span 
                          ...
                          className="font-semibold text-[#16A34A] dark:text-[#22C55E] uppercase"
                        >
                          {assignedRole}
                        </motion.span>
                      </motion.div>
                    ...
                    <div className={`border rounded-xl shadow-sm overflow-hidden ${
                      ...
                      <div className={`p-3 sm:p-3.5 flex items-center justify-between text-xs sm:text-sm transition-colors ${isLight ? "hover:bg-[#F4F4F5]" : "hover:bg-[#1A1A1A]"}`}>
                        <div>
                          ...
                          <div className="font-semibold text-[#16A34A] dark:text-[#22C55E] uppercase mt-0.5">{assignedRole} • MANMADHAN</div>
                        </div>
                        <motion.button
                          type="button"
                          whileTap={shouldReduceMotion ? {} : { scale: 0.92 }}
