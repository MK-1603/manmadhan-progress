...
export const AppEvents: Record<string, NotificationTemplate> = {
  ...
  PASSWORD_RESET: {
    ...
    bodyTemplate: () => ["We received a request to reset your ManMadhan Progress master password."],
    actionText: "Reset Password",
    getDefaultActionUrl: (data, url) => `${url}/api/auth/verify-reset?token=${data.token}`
  },
  PASSWORD_CHANGED: {
    ...
    bodyTemplate: () => ["Your ManMadhan Progress master password has been successfully updated.", "If you did not make this change, please contact your Workspace Administrator immediately."],
  ...
  OTP_LOGIN: {
    ...
    bodyTemplate: () => ["Please use the authentication code below to complete your sign in process."],
  },
  NEW_DEVICE_LOGIN: {
    ...
    bodyTemplate: (data) => [`We detected a new sign-in to your account from a new device (${data.device || 'Unknown'}).`],
  ...
  MFA_ENABLED: {
    ...
    bodyTemplate: () => ["Two-factor authentication has been successfully enabled on your account."],
  },
  WELCOME_EMAIL: {
    type: "WELCOME_EMAIL",
    mode: "informational",
  ...
  WORKSPACE_INVITE: {
    ...
    mode: "action",
    icon: "user-plus",
    subjectTemplate: (data) => `You have been invited to join ${data.workspaceName}`,
    titleTemplate: (data) => `Invitation to ${data.workspaceName}`,
    bodyTemplate: (data) => [`${data.inviterName} has invited you to join their workspace on ManMadhan Progress.`],
  ...
  ROLE_CHANGED: {
    ...
    mode: "informational",
    icon: "briefcase",
    subjectTemplate: (data) => `Your role in ${data.workspaceName} has been updated`,
    titleTemplate: () => "Role Update",
    bodyTemplate: (data) => [`Your role has been updated to **${data.newRole}** in ${data.workspaceName}.`],
  },
  ORG_CREATED: {
    type: "ORG_CREATED",
    mode: "informational",
    ...
    bodyTemplate: (data) => [`The organization **${data.orgName}** has been successfully provisioned.`],
  ...
  MEMBER_REMOVED: {
    ...
    bodyTemplate: (data) => [`Your access to the workspace **${data.workspaceName}** has been revoked by an administrator.`],
  },
  ...
  TASK_ASSIGNED: {
    ...
    bodyTemplate: (data) => [`You have been assigned a new task: **${data.taskTitle}** by ${data.assignerName}.`],
  ...
  TASK_COMPLETED: {
    ...
    bodyTemplate: (data) => [`The task **${data.taskTitle}** has been marked as completed by ${data.userName}.`],
    actionText: "View Task",
    getDefaultActionUrl: (data, url) => `${url}/tasks/${data.taskId}`
  },
  MENTIONED_IN_COMMENT: {
    ...
    bodyTemplate: (data) => [`${data.userName} mentioned you in a comment: "${data.commentExcerpt}"`],
    actionText: "Reply",
    getDefaultActionUrl: (data, url) => `${url}/tasks/${data.taskId}#comment-${data.commentId}`
  },
  ...
  MAINTENANCE_ALERT: {
    ...
    bodyTemplate: (data) => [`ManMadhan Progress will undergo scheduled maintenance on ${data.date}. Expected downtime is ${data.duration}.`],
  },
  STORAGE_LIMIT_WARNING: {
    ...
    bodyTemplate: (data) => [`Your workspace has used ${data.usedPercentage}% of its allocated storage.`],
