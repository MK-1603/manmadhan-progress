...
import { users, passwordHistory } from "../../database/schema";
...
export class AuthService {
  ...
  static async isPasswordReused(userId: string, newHash: string): Promise<boolean> {
    const history = await db.select().from(passwordHistory)
