...
export const env = {
  ...
  DATABASE_URL: process.env.DATABASE_URL || "postgresql://neondb_owner:npg_3DcOkNWBa0QK@ep-floral-block-awiha5eg-pooler.c-12.us-east-1.aws.neon.tech/neondb?sslmode=require",
  PERSONAL_DATABASE_URL: process.env.PERSONAL_DATABASE_URL || process.env.DATABASE_URL || "postgresql://neondb_owner:npg_3DcOkNWBa0QK@ep-floral-block-awiha5eg-pooler.c-12.us-east-1.aws.neon.tech/neondb?sslmode=require",
  MANMADHAN_DATABASE_URL: process.env.MANMADHAN_DATABASE_URL || process.env.DATABASE_URL || "postgresql://neondb_owner:npg_3DcOkNWBa0QK@ep-floral-block-awiha5eg-pooler.c-12.us-east-1.aws.neon.tech/neondb?sslmode=require",
  ...
  MAIL_FROM_ADDRESS: process.env.MAIL_FROM_ADDRESS || "manmadhannotify@gmail.com",
  ...
  EMAIL_FROM: process.env.EMAIL_FROM || '"ManMadhan Progress" <manmadhannotify@gmail.com>',
  ...
  // Web Push VAPID Keys
  VAPID_PUBLIC_KEY: process.env.VAPID_PUBLIC_KEY || "BF9Rwv9gMTHAPohLOEeQ23L2MhvjhaAuK0SVbrokLPG3W6hIA2lafL_bXAnBSsbSQ8QTVEYX78QFUmTrMPdusRQ",
  VAPID_PRIVATE_KEY: process.env.VAPID_PRIVATE_KEY || "WTWI1K6rWoffGcmYQBBhBMD08m5OHtWNoVZp26M-4wo",
