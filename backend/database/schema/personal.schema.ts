import { text, timestamp, integer, boolean, jsonb, pgSchema } from "drizzle-orm/pg-core";
...
export const personalMilestones = personalSchema.table("personal_milestones", {
  id: text("id").primaryKey(),
  projectId: text("project_id").notNull().references(() => personalProjects.id, { onDelete: "cascade" }),
  name: text("name").notNull(),
  description: text("description"),
...
export const personalTasks = personalSchema.table("personal_tasks", {
  ...
  projectId: text("project_id").references(() => personalProjects.id, { onDelete: "cascade" }),
  milestoneId: text("milestone_id").references(() => personalMilestones.id, { onDelete: "set null" }),
...
export const personalSuccessCriteria = personalSchema.table("personal_success_criteria", {
  id: text("id").primaryKey(),
  projectId: text("project_id").notNull().references(() => personalProjects.id, { onDelete: "cascade" }),
...
export const personalProjectFiles = personalSchema.table("personal_project_files", {
  id: text("id").primaryKey(),
  projectId: text("project_id").notNull().references(() => personalProjects.id, { onDelete: "cascade" }),
...
export const personalActivityLogs = personalSchema.table("personal_activity_logs", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  projectId: text("project_id").references(() => personalProjects.id, { onDelete: "cascade" }),
  taskId: text("task_id").references(() => personalTasks.id, { onDelete: "cascade" }),
  milestoneId: text("milestone_id").references(() => personalMilestones.id, { onDelete: "cascade" }),
...
export const personalHabitLogs = personalSchema.table("personal_habit_logs", {
  id: text("id").primaryKey(),
  habitId: text("habit_id").notNull().references(() => personalHabits.id, { onDelete: "cascade" }),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalBookAuthors = personalSchema.table("personal_book_authors", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  name: text("name").notNull(),
...
export const personalBookAuthorLinks = personalSchema.table("personal_book_author_links", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
  authorId: text("author_id").notNull().references(() => personalBookAuthors.id, { onDelete: "cascade" }),
});
...
export const personalBookSeriesLinks = personalSchema.table("personal_book_series_links", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
  seriesId: text("series_id").notNull().references(() => personalBookSeries.id, { onDelete: "cascade" }),
  seriesNumber: text("series_number"), // e.g. "1", "2", "3a"
});

export const personalBookCollections = personalSchema.table("personal_book_collections", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  name: text("name").notNull(),
  description: text("description"),
...
export const personalBookCollectionLinks = personalSchema.table("personal_book_collection_links", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
  collectionId: text("collection_id").notNull().references(() => personalBookCollections.id, { onDelete: "cascade" }),
});

export const personalBookChapters = personalSchema.table("personal_book_chapters", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
...
export const personalReadingSessions = personalSchema.table("personal_reading_sessions", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalBookNotes = personalSchema.table("personal_book_notes", {
  ...
  chapterId: text("chapter_id").references(() => personalBookChapters.id, { onDelete: "set null" }),
  tags: jsonb("tags").default([]),
...
export const personalBookHighlights = personalSchema.table("personal_book_highlights", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalBookActivityLogs = personalSchema.table("personal_book_activity_logs", {
  id: text("id").primaryKey(),
  bookId: text("book_id").notNull().references(() => personalBooks.id, { onDelete: "cascade" }),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalPodcastEpisodes = personalSchema.table("personal_podcast_episodes", {
  id: text("id").primaryKey(),
  podcastId: text("podcast_id").notNull().references(() => personalPodcasts.id, { onDelete: "cascade" }),
  ownerUserId: text("owner_user_id").notNull(),
  title: text("title").notNull(),
  description: text("description"),
...
export const personalLearningSessions = personalSchema.table("personal_learning_sessions", {
  id: text("id").primaryKey(),
  skillId: text("skill_id").notNull().references(() => personalSkills.id, { onDelete: "cascade" }),
  ownerUserId: text("owner_user_id").notNull(),
  date: timestamp("date").defaultNow().notNull(),
  topic: text("topic"),
...
export const personalNoteLinks = personalSchema.table("personal_note_links", {
  id: text("id").primaryKey(),
  sourceNoteId: text("source_note_id").notNull().references(() => personalNotes.id, { onDelete: "cascade" }),
  targetNoteId: text("target_note_id").notNull().references(() => personalNotes.id, { onDelete: "cascade" }),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});

// Phase 3: Journal
export const personalJournalEntries = personalSchema.table("personal_journal_entries", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  date: timestamp("date").defaultNow().notNull(),
  title: text("title").notNull(),
...
export const personalCalendarEvents = personalSchema.table("personal_calendar_events", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  title: text("title").notNull(),
  description: text("description"),
...
export const personalFileAttachments = personalSchema.table("personal_file_attachments", {
  id: text("id").primaryKey(),
  fileId: text("file_id").notNull().references(() => personalFiles.id, { onDelete: "cascade" }),
  sourceType: text("source_type").notNull(), // Project, Task, Book, Note
  sourceId: text("source_id").notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
});

export const personalVaultSessions = personalSchema.table("personal_vault_sessions", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalSecureNotes = personalSchema.table("personal_secure_notes", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  title: text("title").notNull(),
...
export const personalVaultAuditLogs = personalSchema.table("personal_vault_audit_logs", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalFocusSessions = personalSchema.table("personal_focus_sessions", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  taskId: text("task_id").references(() => personalTasks.id, { onDelete: "set null" }),
  projectId: text("project_id").references(() => personalProjects.id, { onDelete: "set null" }),
  startTime: timestamp("start_time").notNull(),
  endTime: timestamp("end_time"),
  durationMinutes: integer("duration_minutes"),
  status: text("status").default("Completed"), // Completed, Interrupted, Cancelled
  createdAt: timestamp("created_at").defaultNow().notNull(),
});

export const personalTimeEntries = personalSchema.table("personal_time_entries", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
...
export const personalDailyScores = personalSchema.table("personal_daily_scores", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  date: text("date").notNull(), // YYYY-MM-DD
...
export const assistantConversations = personalSchema.table("assistant_conversations", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
  title: text("title").notNull(),
  createdAt: timestamp("created_at").defaultNow().notNull(),
...
export const integrationAccounts = personalSchema.table("integration_accounts", {
  id: text("id").primaryKey(),
  ownerUserId: text("owner_user_id").notNull(),
...
export const integrationGoogleCalendars = personalSchema.table("integration_google_calendars", {
  id: text("id").primaryKey(),
  accountId: text("account_id").notNull().references(() => integrationAccounts.id, { onDelete: "cascade" }),
...
export const integrationGoogleCalendarEvents = personalSchema.table("integration_google_calendar_events", {
  id: text("id").primaryKey(),
  calendarId: text("calendar_id").notNull().references(() => integrationGoogleCalendars.id, { onDelete: "cascade" }),
...
export const integrationGithubRepos = personalSchema.table("integration_github_repos", {
  id: text("id").primaryKey(),
  accountId: text("account_id").notNull().references(() => integrationAccounts.id, { onDelete: "cascade" }),
...
export const integrationGithubIssues = personalSchema.table("integration_github_issues", {
  id: text("id").primaryKey(),
  repoId: text("repo_id").notNull().references(() => integrationGithubRepos.id, { onDelete: "cascade" }),
...
export const integrationRssFeeds = personalSchema.table("integration_rss_feeds", {
  id: text("id").primaryKey(),
  accountId: text("account_id").notNull().references(() => integrationAccounts.id, { onDelete: "cascade" }),
...
export const integrationRssArticles = personalSchema.table("integration_rss_articles", {
  id: text("id").primaryKey(),
  feedId: text("feed_id").notNull().references(() => integrationRssFeeds.id, { onDelete: "cascade" }),
